...
function! TestCaseLocateNewASameStart()
	call s:checkLocateClass(s:expect_locate_locations.new_asame_class, 0, 'new', s:asame_info)
endfunction
...
function! TestCaseLocateNewBSameStart()
	call s:checkLocateClass(s:expect_locate_locations.new_bsame_class, 0, 'new', s:bsame_info)
endfunction
...
function! TestCaseLocateBSameClassStart()
	call s:checkLocateClass(s:expect_locate_locations.bsame_class_use, 0, '', s:bsame_info)
endfunction

function! TestCaseLocateBSameClassMid()
	call s:checkLocateClass(s:expect_locate_locations.bsame_class_use, 1, '', s:bsame_info)
endfunction
...
function! TestCaseLocateImplStart()
	call s:checkLocateAbstractMethodImpl(0)
endfunction
